...
const roleBasedRoutes = {
  ...
  '/dashboard': ['admin', 'customer service', 'sales representative', 'home owner'],
  '/location': ['admin', 'customer service', 'sales representative', 'home owner'],
  '/profile': ['admin', 'customer service', 'sales representative', 'home owner'],
}
...
export async function middleware(req) {
  ...
  console.log('🔐 Middleware check:', { pathname, userRole, userId: session.user.id })
